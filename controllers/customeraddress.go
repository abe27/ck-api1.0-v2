...
func GetAllCustomerAddress(c *fiber.Ctx) error {
	var r models.Response
	var obj []models.CustomerAddress
	// Fetch All Data
	err := configs.Store.Find(&obj).Error
	if err != nil {
		r.Message = services.MessageNotFound("CustomerAddress")
		r.Data = &err
		return c.Status(fiber.StatusNotFound).JSON(&r)
	}

	r.Message = services.MessageShowAll("CustomerAddress")
	r.Data = &obj
...
func ShowCustomerAddressByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.CustomerAddress
...
func UpdateCustomerAddressByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.CustomerAddress
	err := c.BodyParser(&obj)
	...
	// Fetch All Data
	db := configs.Store
	var data models.CustomerAddress
