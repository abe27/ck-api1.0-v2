...
func GetAllAssetType(c *fiber.Ctx) error {
	var r models.Response
	var obj []models.AssetType
	// Fetch All Data
	err := configs.Store.Find(&obj).Error
	if err != nil {
		r.Message = services.MessageNotFound("AssetType")
		r.Data = &err
		return c.Status(fiber.StatusNotFound).JSON(&r)
	}
	r.Message = services.MessageShowAll("AssetType")
	r.Data = &obj
...
func ShowAssetTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.AssetType
...
func UpdateAssetTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.AssetType
	err := c.BodyParser(&obj)
...
func DeleteAssetTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	db := configs.Store
	var obj models.AssetType
