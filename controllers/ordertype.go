...
func GetAllOrderType(c *fiber.Ctx) error {
	var r models.Response
	var obj []models.OrderType
	// Fetch All Data
	err := configs.Store.Find(&obj).Error
	if err != nil {
		r.Message = services.MessageNotFound("OrderType")
		r.Data = &err
		return c.Status(fiber.StatusNotFound).JSON(&r)
	}
	r.Message = services.MessageShowAll("OrderType")
	r.Data = &obj
...
func ShowOrderTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.OrderType
...
func UpdateOrderTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.OrderType
	err := c.BodyParser(&obj)
...
func DeleteOrderTypeByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	db := configs.Store
	var obj models.OrderType
