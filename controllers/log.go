...
func GetAllSyncLogger(c *fiber.Ctx) error {
	var r models.Response
	var obj []models.SyncLogger
	// Fetch All Data
	err := configs.Store.Limit(20).Order("updated_at desc").Find(&obj).Error
	if err != nil {
		r.Message = services.MessageNotFound("SyncLogger")
		r.Data = &err
		return c.Status(fiber.StatusNotFound).JSON(&r)
	}
	r.Message = services.MessageShowAll("SyncLogger")
	r.Data = &obj
	return c.Status(fiber.StatusOK).JSON(&r)
}

func CreateSyncLogger(c *fiber.Ctx) error {
	var r models.Response
	var obj models.SyncLogger
...
func ShowSyncLoggerByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.SyncLogger
...
func UpdateSyncLoggerByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.SyncLogger
	err := c.BodyParser(&obj)
...
func DeleteSyncLoggerByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	db := configs.Store
	var obj models.SyncLogger
