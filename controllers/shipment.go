...
func GetAllShipment(c *fiber.Ctx) error {
	var r models.Response
	var obj []models.Shipment
	// Fetch All Data
	err := configs.Store.Find(&obj).Error
	if err != nil {
		r.Message = services.MessageNotFound("Shipment")
		r.Data = &err
		return c.Status(fiber.StatusNotFound).JSON(&r)
	}
	r.Message = services.MessageShowAll("Shipment")
	r.Data = &obj
...
func ShowShipmentByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.Shipment
...
func UpdateShipmentByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	var obj models.Shipment
	err := c.BodyParser(&obj)
...
func DeleteShipmentByID(c *fiber.Ctx) error {
	var r models.Response
	id := c.Params("id")
	db := configs.Store
	var obj models.Shipment
